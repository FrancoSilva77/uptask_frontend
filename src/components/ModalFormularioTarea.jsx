              ...
              <div className="sm:flex sm:items-start">
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                  ...
                  <form onSubmit={handleSubmit} className='my-10'>
                    <div className="mb-5">
                      <label htmlFor="nombre" className='text-gay-700 uppercase font-bold text-sm'>
                        Nombre Tarea:
                      </label>
                      <input type="text"
                        id='nombre'
                    ...
                    <div className="mb-5">
                      <label htmlFor="descripcion" className='text-gay-700 uppercase font-bold text-sm'>
                        Descripción Tarea:
                      </label>
                      <textarea
                        id='descripcion'
                    ...
                    <div className="mb-5">
                      <label htmlFor="fecha-entrega" className='text-gay-700 uppercase font-bold text-sm'>
                        Fecha de Entrega:
                      </label>
                      <input type="date"
                        id='fecha-entrega'
                    ...
                    <div className="mb-5">
                      <label htmlFor="prioridad" className='text-gay-700 uppercase font-bold text-sm'>
                        Prioridad
                      </label>
                      <select
                        id='prioridad'
